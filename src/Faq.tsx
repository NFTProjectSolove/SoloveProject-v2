    ...
    return (
        ...
        <div id='faq' style={{ backgroundColor: 'black', width: '100vw', height: '150vh', position: 'relative', top: '0', overflow: 'hidden' }}>
          ...
          <div style={{paddingTop:'30px'}}></div>
            <Accordian questiontext = "What are the official links?" answertext1 = "Please only use the following links" answertext2= "Minting Website: www.solove.com" answertext3 = "Twitter: twitter.com/solove" answertext4= "Discord: discord.gg/solove" answertext5 = "Please be aware that we will ever DM you or contact you directly" answertext6 = "" answertext7 = ""answertext8 = "" />
          <div style={{paddingTop:'30px'}}></div>
