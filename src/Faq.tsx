    ...
    return (
        ...
        <div id='faq' style={{ backgroundColor: 'black', width: '100vw', height: '150vh', position: 'relative', top: '0', overflow: 'hidden' }}>
          ...
          <div style={{paddingTop:'30px'}}></div>
            <Accordian questiontext = "What are the official links?" answertext1 = "Please only use the following links" answertext2= "Minting Website: www.solove.site/Mint" answertext3 = "Twitter: www.twitter.com/SoloveNFT" answertext4= "" answertext5 = "Please be aware that we will ever DM you or contact you directly" answertext6 = "" answertext7 = ""answertext8 = "" />
          <div style={{paddingTop:'30px'}}></div>
